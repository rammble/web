...
export default function ConnectionFields({isSignUpPage}: { isSignUpPage: boolean }) {
    ...
    <Box w={'100%'}>
      ...
      <Center mt={'32px'}>
        <Flex alignItems={'center'}>
          ...
          <Text cursor={'pointer'} fontWeight={400} fontSize={'14px'} ml={2} onClick={() => router.push(isSignUpPage ? '/signin' : '/signup')} color={'brand'}>
