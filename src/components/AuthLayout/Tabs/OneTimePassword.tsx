    ...
    <Flex gap={4} w={'350px'} flexDir={'column'}>
      <Flex flexDir={'column'} gap={4}>
        ...
        <Text fontSize={'16px'} fontWeight={400} color={'ui.80'}>
          This account is protected with 2-factor authentication, if you really
          are who you say you are, enter the code from your authenticator,
          email, or SMS app.
        </Text>
      </Flex>
      <Center m={20}>
