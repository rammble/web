...
export const GoogleIcon = createIcon({
  ...
  path: (
    ...
    >
      ...
      />
      <path
        d="M11.9999 23C14.9699 23 17.4599 22.02 19.2799 20.34L15.7099 17.57C14.7299 18.23 13.4799 18.63 11.9999 18.63C9.13993 18.63 6.70993 16.7 5.83993 14.1H2.17993V16.94C3.98993 20.53 7.69993 23 11.9999 23Z"
        fill="#34A853"
      />
      <path
